...
class BarangModel {
    ...
    public function tambahBarang($data){
        ...
        $query = "INSERT INTO tb_peminjaman (nama_peminjam, jenis_barang, no_barang, tgl_pinjam, tgl_kembali, status) VALUES(:nama_peminjam, :jenis_barang, :no_barang, :tgl_pinjam, :tgl_pinjam,  :status)";
        $this->db->query($query);
    ...
    public function cariBarang(){
        ...
        $this->db->query("SELECT * FROM tb_peminjaman WHERE nama_peminjam LIKE :keyword OR jenis_barang LIKE :keyword");
